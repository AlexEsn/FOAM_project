...
duct = geompy.MakeBoxDXDYDZ(70, 70, 50)
geompy.TranslateDXDYDZ(duct, -10, -10, 3)
...
Block_1 = geompy.MakeBoxDXDYDZ(10, 10, 40)
...
for i, value in enumerate(blocks):
    if value == 1:
        Blocks.append(geompy.MakeTranslation(
            Block_1, (i % num_in_row) * 10, (i // num_in_row) * 10, 0))
...
inlet_fluid_id = [i for i in inlet_fluid_id if i in all_walls_fluid_ids]
outlet_fluid_id = [i for i in outlet_fluid_id if i in all_walls_fluid_ids]
