...
sys.path.insert(0, r'C:/Users/sasch/OneDrive/Desktop/MEPhI/Project_practice/FOAM_project/heatExchanger/salome')
...
substrate = geompy.MakeBoxDXDYDZ(30, 30, 10)
geompy.TranslateDXDYDZ(substrate, -10, -10, 10)
duct = geompy.MakeBoxDXDYDZ(300, 50, 100)
geompy.TranslateDXDYDZ(duct, -150, -20, 10)
geomObj_1 = geompy.MakeConeR1R2H(5, 0, 10)
geompy.TranslateDXDYDZ(geomObj_1, -5, -5, 20)
geomObj_2 = geompy.MakeTranslation(geomObj_1, 10, 0, 0)
geomObj_3 = geompy.MakeTranslation(geomObj_1, 20, 0, 0)
Cone_1 = geompy.MakeTranslation(geomObj_1, 0, 10, 0)
Cone_2 = geompy.MakeTranslation(geomObj_2, 0, 10, 0)
Cone_3 = geompy.MakeTranslation(geomObj_3, 0, 10, 0)
fins = geompy.MakeFuseList([Cone_1, substrate, Cone_2, Cone_3], True, True)
...
geompy.UnionIDs(inlet_fluid, [104])
outlet_fluid = geompy.CreateGroup(fluidHeaterFins, geompy.ShapeType["FACE"])
geompy.UnionIDs(outlet_fluid, [135])
walls_fluid = geompy.CreateGroup(fluidHeaterFins, geompy.ShapeType["FACE"])
geompy.UnionIDs(walls_fluid, [114, 121, 126, 131])
walls_heater = geompy.CreateGroup(fluidHeaterFins, geompy.ShapeType["FACE"])
geompy.UnionIDs(walls_heater, [32, 28, 14, 24, 4])
base_fins = geompy.CreateGroup(fluidHeaterFins, geompy.ShapeType["FACE"])
geompy.UnionIDs(base_fins, [99])
[heater_1, fluid_1, fins_1, inlet_fluid, outlet_fluid, walls_fluid, walls_heater, base_fins] = geompy.GetExistingSubObjects(fluidHeaterFins, False)
[heater_1, fluid_1, fins_1, inlet_fluid, outlet_fluid, walls_fluid, walls_heater, base_fins] = geompy.GetExistingSubObjects(fluidHeaterFins, False)
fluid.SetAutoColor(1)
